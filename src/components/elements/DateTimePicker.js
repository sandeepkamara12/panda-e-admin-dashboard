...
const DateTimePicker = () => {
  return (
    <div className="space-y-2">
      ...
      <div className="w-80 sm:w-[638px] flex flex-col bg-white border shadow-lg rounded-xl overflow-hidden dark:bg-neutral-900 dark:border-neutral-700">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 py-3 px-4 border-t dark:border-neutral-700">
          ...
          <div className="flex items-center md:justify-end gap-x-2">
            <span className="md:me-3 text-xs text-gray-500 dark:text-neutral-500">
