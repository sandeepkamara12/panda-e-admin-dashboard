...
const MultipleImageUpload = ({ uploadedImages }) => {
  ...
  return (
    <div className="space-y-4 span-col-1">
      <label className="inline-block text-sm font-medium text-gray-800 dark:text-neutral-200">
        Product Images
      </label>
      <div className="grid gap-4">
        <div className="">
          ...
          >
            <li className="cursor-grab relative animate-pulse">
              <div className="bg-gray-200 w-[30px] h-[30px] absolute z-10 -right-1 -top-1 rounded-full flex flex-wrap items-center justify-center ">
              </div>
        ...
        <div className="">
          ...
          <p
            className="mt-2 text-xs text-gray-500 dark:text-neutral-500"
            id="hs-textarea-helper-text"
          >
            Drag Images: First image would be the main image.
          </p>
          <p
            className="mt-2 text-xs text-gray-500 dark:text-neutral-500"
            id="hs-textarea-helper-text"
          >
            Maximum 8 files can be upload.
          </p>
        </div>
      </div>
    </div>
