...
const Header = ({ pathname }) => {
  return (
    ...
    //                         <img className="h-8 w-auto" src="/logo-white.png" alt="Your Company" />
    //                     </div>
    //                     {/* Sidebar Toggle Button */}
    //                     <button type="button" onClick={()=>hideSidebar(!sidebar)} className="hidden xl:flex relative mx-4 rounded-full bg-gray-800 p-1 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
    ...
    //                             <a href="#" className="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabIndex="-1" id="user-menu-item-0">My Account</a>
    //                             <a href="#" className="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabIndex="-1" id="user-menu-item-0">Reset Password</a>
